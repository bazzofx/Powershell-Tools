...
Write-Host "You can use the switches together, without specifying the filePath, you will be prompted with a dialog box"
Write-Host "procmap -f -n `n"  -ForegroundColor Gray

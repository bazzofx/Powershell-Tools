...
Get-MsolDomain -ErrorAction SilentlyContinue 
    ...
    Write-Host "error here funlogin365"
...
Add-Content $logBad "----------- UNLOCKING ACCOUNT EXCEPTION LOG START --------------"    
    Try{
        ...
        ForEach ($row in $global:users)
            ...
            Add-Content $logBad ""
#Update text for pop up
$lbl_confirmation.text = "Accounts have been unlocked successfully!"
#creates form
$window2.ShowDialog()
#cleans up
$window2.Dispose()
...
checkConnection
    ...
    Try{
        ...
        $count+=1
            ...
            Add-Content $logBad ""
#Update text for pop up
$lbl_confirmation.text = "ES2 Licenses have been added to the accounts successfully"
#creates form
$window2.ShowDialog()
#cleans up
$window2.Dispose()       
...
Add-Content $logBad ""
    Try{
        ...
        ForEach ($row in $global:users)
            ...
            Add-Content $logBad ""
#Update text for pop up
$lbl_confirmation.text = "Accounts have been LOCKED successfully!"
#creates form
$window2.ShowDialog()
#cleans up
$window2.Dispose() 
    ...
    Try{        
        ...
        foreach{
           ...
           $count +=1
            ...
            Add-Content $logBad "" 
#Update text for pop up
$lbl_confirmation.text = "ALL lisences have now been removed from the accounts."
#creates form
$window2.ShowDialog()
#cleans up
$window2.Dispose()            
...
##SUB WINDOW
$window2 = New-Object $FormObject
$window2.MaximumSize="300,150"
$window2.MinimumSize="300,150"
$window2.ClientSize="300,150"
$window2.Text="SUCCESS"
$window2.backcolor = "lightgray"


    #Define label for sub window
$lbl_confirmation = New-Object $LabelObject
$lbl_confirmation.text = ""
$lbl_confirmation.Autosize = $false
$lbl_confirmation.Width="270"
$lbl_confirmation.Height="250"
$lbl_confirmation.Font="Cambria,10,style=bold" ### --------------------------------------------font here
$lbl_confirmation.Location = New-Object system.drawing.point (5,10)

    #Define OK button for sub window
$btn_ok = New-Object $ButtonObject
$btn_ok.text="                OK                "
$btn_ok.AutoSize=$true
$btn_ok.Font="Arial,8,style=bold"
$btn_ok.Location = New-Object System.Drawing.Point(60,60)
...
$btn_ok.Add_Click({closePopupWindow})
...
$window2.Controls.AddRange(@($btn_ok,$lbl_confirmation))
#creates form
$window.ShowDialog()
#cleans up
$window.Dispose()

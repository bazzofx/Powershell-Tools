...
$newRowList = @()
    forEach($x in $childCmdMissing){
        ...
        elseif($tracker -like "*.png" -or $tracker -like "*.jpeg" -or $tracker -like "*.jpg" -or $tracker -like "*.gif" -or $tracker -like "*.webp"){$selectImage = $global:imageIcon}
...
Write-Host "                 Please make sure the file has the following headers            " -ForegroundColor Green

...
function debugRun{
$data = Import-Csv "C:\Users\paulo.bazzo\OneDrive - NEC Software Solutions\Documents\Projects\Auto-Diagram\ProcessMap\v_5.1\dataSample1_v5.csv"
...
generateTemp1 ;Write-Host "[SUCCESS] Generating Temp1 file..." -ForegroundColor Gray;sleep .5
mergeData ;Write-Host "[SUCCESS] Merging the columns together..." -ForegroundColor Gray;sleep .5
addMissingDestinations; Write-Host "[SUCCESS] Adding Draw.IO components.." -ForegroundColor Gray;sleep .5
mergeScriptData; Write-Host "[SUCCESS] Sprinkling a bit of magic.." -ForegroundColor Gray;sleep 2
cleanUp

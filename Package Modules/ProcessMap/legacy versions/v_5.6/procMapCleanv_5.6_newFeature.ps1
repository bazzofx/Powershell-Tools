...
generateTemp1 
Write-Host "[SUCCESS] Generating Temp1 file..." -ForegroundColor Gray;sleep 1

mergeData 
Write-Host "[SUCCESS] Merging the columns together..." -ForegroundColor Gray;sleep 1

addMissingDestinations;sleep 2
addMissingProcessCmd
Write-Host "[SUCCESS] Adding Draw.IO components.." -ForegroundColor Gray;sleep 1
